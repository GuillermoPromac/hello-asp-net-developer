...
public class Developer(string firstName, string lastName)
{
    ...
    public string FirstName { get; } = string.IsNullOrEmpty(firstName) ? string.Empty : firstName.Trim();
    public string LastName { get; } = string.IsNullOrEmpty(lastName) ? string.Empty : lastName.Trim();
